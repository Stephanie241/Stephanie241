...
![Power BI](https://img.shields.io/badge/Power%20BI-%23F2C811.svg?style=for-the-badge&logo=Power-BI&logoColor=white) ![Looker](https://img.shields.io/badge/Looker-%234285F4.svg?style=for-the-badge&logo=looker&logoColor=white) ![Domo](https://img.shields.io/badge/Domo-%23A6D2B4.svg?style=for-the-badge&logo=domo&logoColor=white) ![Excel](https://img.shields.io/badge/Excel-%2312A6C1.svg?style=for-the-badge&logo=microsoft-excel&logoColor=white)

### Version Control:
![Git](https://img.shields.io/badge/git-%23F05033.svg?style=for-the-badge&logo=git&logoColor=white) ![GitHub](https://img.shields.io/badge/github-%23121011.svg?style=for-the-badge&logo=github&logoColor=white) 

### Enterprise Platforms & APIs:
![Oracle Fusion](https://img.shields.io/badge/Oracle%20Fusion-%23FF0000.svg?style=for-the-badge&logo=oracle&logoColor=white) ![SCIM](https://img.shields.io/badge/SCIM%20-%23007ACC.svg?style=for-the-badge&logo=openid&logoColor=white) ![REST APIs](https://img.shields.io/badge/REST%20APIs-%23000000.svg?style=for-the-badge&logo=swagger&logoColor=white) ![RBAC](https://img.shields.io/badge/RBAC-%234A90E2.svg?style=for-the-badge)
...
|--------------|--------------|---------------------|
| [Oracle Fusion Data Platform with dbt & MCP](https://github.com/Stephanie241/fusion-analytics-platform) | Python, Oracle Fusion REST APIs, dbt, SQL, MCP (Model Context Protocol), Claude Desktop, Data Modelling, ETL, Analytics Engineering | End-to-end analytics engineering project extracting data from Oracle Fusion APIs, modelling it with dbt (staging, intermediate, and marts), and exposing the pipeline via an MCP server to enable LLM-driven exploration and analysis through Claude Desktop. |
| [dbt Health API Project with Databricks](https://github.com/Stephanie241/dbt_databricks) | Python, dbt, Databricks, SQL, API Integration, Data Modeling, Incremental ETL, Data Testing, Data Visualization | End-to-end data pipeline fetching health data from the OpenFDA API, storing it as a seed, transforming it with dbt staging and mart models, applying incremental loading, and testing data integrity in Databricks. |
